...
export const mapItemFromApi = (item: ApiPedidoItem, orderId: number, index: number): OrderItem => {
    ...
    return {
        ...
        valor_ilhos: item.valor_ilhos != null ? toCurrencyString(item.valor_ilhos ?? item.ilhos_valor_unitario) : undefined,
        quantidade_cordinha: item.quantidade_cordinha ?? undefined,
        espaco_cordinha: item.espaco_cordinha ?? undefined,
        valor_cordinha: item.valor_cordinha != null ? toCurrencyString(item.valor_cordinha) : undefined,
        ...
        valor_painel: item.valor_painel != null ? toCurrencyString(item.valor_painel) : undefined,
        valores_adicionais: item.valores_adicionais != null ? toCurrencyString(item.valores_adicionais) : undefined,
        valor_unitario: item.valor_unitario != null ? toCurrencyString(item.valor_unitario) : undefined,
        ...
        valor_lona: item.valor_lona != null ? toCurrencyString(item.valor_lona) : undefined,
        outros_valores_lona: item.outros_valores_lona != null ? toCurrencyString(item.outros_valores_lona) : undefined,
        tipo_adesivo: item.tipo_adesivo ?? undefined,
        quantidade_adesivo: item.quantidade_adesivo ?? undefined,
        valor_adesivo: item.valor_adesivo != null ? toCurrencyString(item.valor_adesivo) : undefined,
        outros_valores_adesivo: item.outros_valores_adesivo != null ? toCurrencyString(item.outros_valores_adesivo) : undefined,
