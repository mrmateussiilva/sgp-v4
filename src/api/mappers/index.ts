...
export const mapItemFromApi = (item: ApiPedidoItem, orderId: number, index: number): OrderItem => {
    ...
    return {
        ...
        valor_ilhos: parseMonetary(item.valor_ilhos ?? item.ilhos_valor_unitario) || undefined,
        quantidade_cordinha: item.quantidade_cordinha ?? undefined,
        espaco_cordinha: item.espaco_cordinha ?? undefined,
        valor_cordinha: parseMonetary(item.valor_cordinha) || undefined,
        ...
        valor_painel: parseMonetary(item.valor_painel) || undefined,
        valores_adicionais: parseMonetary(item.valores_adicionais) || undefined,
        valor_unitario: parseMonetary(item.valor_unitario) || undefined,
        ...
        valor_lona: parseMonetary(item.valor_lona) || undefined,
        outros_valores_lona: parseMonetary(item.outros_valores_lona) || undefined,
        tipo_adesivo: item.tipo_adesivo ?? undefined,
        quantidade_adesivo: item.quantidade_adesivo ?? undefined,
        valor_adesivo: parseMonetary(item.valor_adesivo) || undefined,
        outros_valores_adesivo: parseMonetary(item.outros_valores_adesivo) || undefined,
        ...
        valor_totem: parseMonetary(item.valor_totem) || undefined,
        outros_valores_totem: parseMonetary(item.outros_valores_totem) || undefined,
