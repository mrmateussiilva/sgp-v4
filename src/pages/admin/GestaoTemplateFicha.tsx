...
const AVAILABLE_FIELDS: Omit<TemplateField, 'x' | 'y' | 'width' | 'height'>[] = [
  ...
  { id: 'valor_lona', type: 'currency', label: 'Valor Lona', key: 'valor_lona' },
  { id: 'outros_valores_lona', type: 'currency', label: 'Outros Valores Lona', key: 'outros_valores_lona' },
  { id: 'acabamento_totem', type: 'text', label: 'Acabamento (Totem)', key: 'acabamento_totem' },
  { id: 'acabamento_totem_display', type: 'text', label: 'Acabamento Totem (Formatado)', key: 'acabamento_totem_display' },
  ...
  { id: 'valor_totem', type: 'currency', label: 'Valor Totem', key: 'valor_totem' },
  { id: 'outros_valores_totem', type: 'currency', label: 'Outros Valores Totem', key: 'outros_valores_totem' },
  ...
  { id: 'valor_adesivo', type: 'currency', label: 'Valor Adesivo', key: 'valor_adesivo' },
  { id: 'outros_valores_adesivo', type: 'currency', label: 'Outros Valores Adesivo', key: 'outros_valores_adesivo' },
